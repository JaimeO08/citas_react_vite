const Paciente = ({paciente, setPaciente, eliminarPaciente}) => {
  ...
  return (
    <div className="mx-5 my-3 bg-white shadow-md m-3 px-5 py-10 rounded-xl">
        ...
        <div className="flex justify-between mt-10">
            <button
                ...
                onClick={() => setPaciente(paciente)} // Arrow Function para no llamar automaticamente a la función
            >Editar
